...
import net.molho.mccourse.screen.renderer.EnergyInfoArea;
import net.molho.mccourse.screen.renderer.FluidStackRenderer;
import net.molho.mccourse.util.MouseUtil;
...
public class GemEmpoweringScreen extends HandledScreen<GemEmpoweringScreenHandler> {
    ...
    public boolean isMouseAboveArea(int pMouseX, int pMouseY, int x, int y, int offsetX, int offsetY, FluidStackRenderer renderer) {
