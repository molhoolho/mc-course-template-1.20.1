package net.molho.mccourse.compat;
...
public class GemEmpoweringCategory implements DisplayCategory<BasicDisplay> {
    ...
    public static final CategoryIdentifier<GemEmpoweringDisplay> GEM_EMPOWERING =
            CategoryIdentifier.of(MCCourse.MOD_ID, "gem_empowering");
    ...
    public List<Widget> setupDisplay(BasicDisplay display, Rectangle bounds) {
        ...
        widgets.add(Widgets.createTooltip(new Rectangle(startPoint.x + 156, startPoint.y + 11, 8, 64),
                Text.literal("Needs 2304 E")));
