package net.molho.mccourse.entity.custom;
...
import net.molho.mccourse.entity.ai.PorcupineAttackGoal;
...
public class PorcupineEntity extends TameableEntity implements Mount{
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(2, new FollowOwnerGoal(this, 1.1D, 10, 3f, false));
    ...
    private void setupAnimationStates() {
        ...
        if(this.isAttacking() && attackAnimationTimeout == 0){
            attackAnimationTimeout = 40; //LENGTH ANIMATION IN TICKS
    ...
    private void setVariants(PorcupineVariant variant){
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        Item itemForTaming = ModItens.CAULIFLOWER;
