package net.molho.mccourse.blocks.entity.renderer;
...
import net.molho.mccourse.blocks.entity.GemEmpoweringStationBlockEntity;
...
public class GemEmpoweringBlockEntityRenderer implements BlockEntityRenderer<GemEmpoweringStationBlockEntity> {
    ...
    public void render(GemEmpoweringStationBlockEntity entity, float tickDelta, MatrixStack matrices,
        ...
        matrices.multiply(RotationAxis.NEGATIVE_Y.rotationDegrees(entity.getCachedState().get(GemEmpoweringStation.FACING).asRotation()));
