...
public class GemEmpoweringRecipe implements Recipe<SimpleInventory> {
    ...
    private final DefaultedList<Ingredient> recipeItens;

    public GemEmpoweringRecipe(Identifier id, ItemStack output, DefaultedList<Ingredient> recipeItens){
        this.id = id;
        this.output = output;
        this.recipeItens = recipeItens;
    }
    ...
    public boolean matches(SimpleInventory inventory, World world) {
        ...
        return recipeItens.get(0).test(inventory.getStack(0));
    }
